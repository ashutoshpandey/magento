...
<div><span class='setavailability link'>Set Availability</span><br/><br/></div>
                ...
                foreach($appointments as $appointment){
                    ...
                    <tr>
                        ...
                        <td style="padding-top:15px;">
                            ...
                            <i class="fa fa-user fa-1x pointer" rel="{{$appointment->id}}" data-toggle="modal" title="User Information"></i> &nbsp;&nbsp;
                            <i class="fa fa-search fa-1x pointer" rel="{{$appointment->id}}" title="Appointment Information"></i> &nbsp;&nbsp;
                            <i class="fa fa-times fa-1x pointer" rel="{{$appointment->id}}" title="Cancel Appointment"></i></td>
                    </tr>
