...
<section class="wrapper">
    ...
    <nav role="navigation" class="navbar navbar-default navbar-top navbar-fixed-top">
        ...
        <div class="navbar-header">
            <a href="#" class="navbar-brand">
                <div class="brand-logo">Expert Section</div>
                <div class="brand-logo-collapsed">Expert Section</div>
            </a>
        </div>
        <!-- END navbar header-->
        <!-- START Nav wrapper-->
        <div class="nav-wrapper">
            <!-- START Left navbar-->
            <div style="float: left; padding: 15px 0 0 30px;"><b>Welcome</b> [ <span style="color:#ff8517">{{$expert_name}}</span> ]</div>
    ...
    {{HTML::script(asset("/public/js/expert.js"))}}
