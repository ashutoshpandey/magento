            ...
            <div class="col-lg-5 expert-detail-data">
                <div class="row">
                    ...
                    <div class="col-lg-8" style="font-size: 16px;">
                        Consultancy Fees: ${{$expert->fees_dollar}}
                    </div>
                </div>
                <div class="clear"></div>
                <div class="col-lg-12" style="padding-top: 10px;">
                    ...
                    <div class="col-md-4" style="font-size: 16px; height:35px; padding-top: 5px; text-align: center; font-weight: bold; background-color: rgb(34,177,76); color: white;">
                        View Blog
                    </div>
                </div>
